...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .moveit_cpp(file_path="config/planning_python.api.yaml")
        .to_moveit_configs()
    )
    ...
    # the task server node is a py script useful only for ROS2 version from iron and recents one (ometted in ROS2 HUMBLE)
    # task_server_node = Node(
    #     package="arduinobot_remote",
    #     executable="task_server_node",
    # )
